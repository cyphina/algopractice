...
TEST_CASE("Test Longest Common Subsequence", "[lcs]")
{
   ...
   const auto ResultDynamic{HockeyCommonSubsequenceDynamic(Team1GameResults, Team2GameResults)};
   REQUIRE(Result.MaxRivalGamePoints == 20);
   REQUIRE(ResultDynamic.MaxRivalGamePoints == 20);
   ...
   const auto Result2Dynamic{HockeyCommonSubsequenceDynamic(Team1GameResults2, Team2GameResults2)};

   REQUIRE(Result2Dynamic.MaxRivalGamePoints == 0);
   REQUIRE(Result2Dynamic.MaxRivalGamePoints == 0);
   ...
   const auto Result3Dynamic{HockeyCommonSubsequenceDynamic(Team1GameResults3, Team2GameResults3)};

   REQUIRE(Result3.MaxRivalGamePoints == 54);
   REQUIRE(Result3Dynamic.MaxRivalGamePoints == 54);
}
